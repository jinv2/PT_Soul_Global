<p align="center">
  <img src="assets/logo_ts.webp" width="128" alt="Shensist Logo">
</p>
...
## 🛡️ 法律声明与版权 (Copyright & Legal)
**本软件受国际版权法及 Shensist Matrix 专有协议保护。**
* **唯一官方渠道**：[https://shensist.top/](https://shensist.top/)
* **所有权**：Shensist-Agent Architect
* **版权所有**：© 2026 Shensist Matrix. 保留所有权利。
...
## 🛠️ 安装指南 (Mac/Ubuntu)
1. 运行 `setup_mac.sh` 进行环境初始化。
2. 确保 `assets/logo_ts.webp` 完整，否则 UI 将拒绝加载品牌信息。
3. 访问 [shensist.top](https://shensist.top/) 获取您的专属激活码。

---
<p align="center">
  <b>Powered by Shensist Matrix</b><br>
  <i>Empowering Audio Engineers with AI Intelligence.</i>
</p>
